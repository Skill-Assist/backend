/**
 * @typedef {Object} ChallengeQuestionSchema: Schema de questão do tipo "challenge" (desafio).
 *
 * @property {string} type - tipo da questão: "challenge" (desafio)
 ...
 */
export interface ChallengeQuestionSchema {
  type: "challenge";
  statement: string;
  gradingRubric: {
    criteria: {
